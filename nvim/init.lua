...
-- scrooloose/nerdtree
api.nvim_set_var('NERDTreeDirArrows', 1)
api.nvim_set_var('NERDTreeDirArrowExpandable', '▸')
api.nvim_set_var('NERDTreeDirArrowCollapsible', '▾')
...
vim.opt.fileencodings = 'utf-8,big5,gb2312,gb18030,gbk,ucs-bom,cp936,latin1'
